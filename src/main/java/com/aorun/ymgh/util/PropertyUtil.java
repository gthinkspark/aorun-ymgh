	 ...
	 */
	    ...
	    public PropertyUtil(String path){
	        try {
	            ...
	            commonMap = PropertyUtil.loadProperties(commonFile);
	    ...
	    public static Hashtable<String, String> loadProperties(File propFile) {
	        if (!propFile.exists())
	            throw new RuntimeException("Config file <" + propFile.getAbsolutePath()
	                                       + "> doesn't exists.");
		...
		public static void main(String[] args) {
			PropertyUtil p = new PropertyUtil(System.getenv("going_config_path") + "/office-web/common.properties");
			System.out.println(p.getCommonConf("SERVER_HOST"));
		}
}
